...
import {clearSurvey,toggleActiveSurvey, getOneSurvey,getSurveys,}  from '../actions';
...
class SurveyComponent extends Component {
    ...
    render(){
        ...
        if(this.props.surveyPaginate.data) dataSurvey = concat(dataSurvey,this.props.surveyPaginate.data);
        ...
        <Grid container spacing={8} direction='column' className={classes.container}>
            <Grid container direction='row' alignContent="flex-start">
                ...
                <Grid item  xs={2} align="right">
                    <Fab onClick={() => history.push('/app/survey/create')} size="small" color="secondary" aria-label="Add" className={classes.fab}>
                        <AddIcon />
                    </Fab>
                </Grid>
            ...
            <Table >
                <TableHead>
                    <TableRow>
                        ...
                        <TableCell align="center" className={classes.widthDate}>Status</TableCell>
                    ...
                    {dataSurvey.map(row => {
                        ...
                        return (
                            ...
                            <TableCell align="center">
                            <IconButton onClick={() => this.getSurveyDetail(row.id)} size="small" color="primary" aria-label="Detail" >
